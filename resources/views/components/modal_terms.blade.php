    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Terms and Conditions<br /></h4><button class="btn-close" type="button"
                    data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div>
                    <p>Welcome to Imgee!</p>
                    <p>
                        These terms and conditions outline the rules and regulations for the use of
                        Imgee&#39;s Website, located at imgee.io.
                    </p>
                    <p>
                        By accessing this website we assume you accept these terms and conditions. Do
                        not continue to use Imgee if you do not agree to take all of the terms and
                    ...
                    <p>
                        We employ the use of cookies. By accessing Imgee, you agreed to use cookies in
                        agreement with the Imgee&#39;s Privacy Policy.
                    </p>
                    <p>
                    ...
                    <p>
                        Unless otherwise stated, Imgee and/or its licensors own the intellectual
                        property rights for all material on Imgee. All intellectual property rights
                        are reserved. You may access this from Imgee for your own personal use
                        subjected to restrictions set in these terms and conditions.
                    </p>
                    <p>You must not:</p>
                    <ul>
                        <li>Republish material from Imgee</li>
                        <li>Sell, rent or sub-license material from Imgee</li>
                        <li>Reproduce, duplicate or copy material from Imgee</li>
                        <li>Redistribute content from Imgee</li>
                    </ul>
                    <p>
                        This Agreement shall begin on the date hereof. Our Terms and Conditions were
                        created with the help of the
                        <a href="https://www.termsfeed.com/terms-conditions-generator/">Terms And Conditions
                            Generator</a>.
                    </p>
                    <p>
                        Parts of this website offer an opportunity for users to post and exchange
                        opinions and information in certain areas of the website. Imgee does not
                        filter, edit, publish or review Comments prior to their presence on the
                        website. Comments do not reflect the views and opinions of Imgee,its agents
                        ...
                        Imgee shall not be liable for the Comments or for any liability, damages or
                        expenses caused and/or suffered as a result of any use of and/or posting of
                        and/or appearance of the Comments on this website.
                    </p>
                    <p>
                        Imgee reserves the right to monitor all Comments and to remove any Comments
                    ...
                    <p>
                        You hereby grant Imgee a non-exclusive license to use, reproduce, edit and
                    ...
                    <p>
                        ...
                        absence of Imgee; and (d) the link is in the context of general resource
                        information.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        to Imgee. Please include your name, your organization name, contact
                    ...
                    <p>
                        No use of Imgee&#39;s logo or other artwork will be allowed for linking absent a
